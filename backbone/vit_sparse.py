...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                 drop_path=0., kw_percent_on=1, norm_layer=nn.LayerNorm):
        super().__init__()
...
def vitsmall_sparse(nclasses: int, kw_percent_on=1, p_size=4, embed_type=None, depth=12):
    return SparseVit(img_size=224, patch_size=16, num_classes=nclasses,
